...
export default function AresInterLanding() {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <a href="#home" className="flex items-center gap-2">
              <div className="relative h-[64px] w-[64px] rounded-xl bg-gradient-to-br from-emerald-400 to-cyan-500 overflow-hidden flex items-center justify-center">
  <Image
  ...
  />
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm text-neutral-300">
              ...
              <a href="#industry" className="hover:text-white">Sports Betting</a>
            ...
            <button
              ...
              className="md:hidden rounded-xl border border-white/20 px-3 py-1 text-sm"
            >
              Menu
            </button>
            <a
              href="#contact"
              className="hidden md:inline-flex items-center rounded-2xl border border-white/20 px-4 py-2 text-sm font-medium hover:bg-white/10"
            >
              Free Consultation
            </a>
          </div>
